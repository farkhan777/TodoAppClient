...
const Navbar = () => {
    ...
    // const currentUser = {
    //     id:1,
    //     username: "Farkhan Hamzah Firdaus",
    //     isSeller: true
    // }
        ...
        <div className='container'>
            <div className="logo">
                <Link to="/" className='link'>
                    <span className='text'>Todo App</span>
                </Link>
                    <span className='dot'>.</span>
            </div>
            <div className="links">
                {/* <span>Xiver Business</span> 
                <span>Explore</span>
                <span>English</span> */}
                {currentUser && <Link to="/items" className='link'>Items</Link>}
                {!currentUser && <Link to="/login" className='link'>Sign in</Link>}
                {!currentUser && <button><Link to="/register" className='link'>Join</Link></button>}
                {currentUser && (
        ...
        {/* { (active || pathname !== '/') &&
            <>
                ...
                <div className='menu'>
                    ...
                    <Link to='/' className='link'>Writting & Translation</Link>
